...
- Use report_impossible(reason=no_viable_plan) only for diagnostic cases after visible crafting, mining, trading, inspection, exploration, loot, brewing, farming, combat, and waiting options relevant to the task are exhausted or blocked.
...
TEXTCRAFT_ACTION_GUIDE = MYTEXTCRAFT_ACTION_GUIDE
